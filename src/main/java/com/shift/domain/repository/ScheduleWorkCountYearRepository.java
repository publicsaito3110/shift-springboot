 ...
 */
@Repository
public interface ScheduleWorkCountYearRepository extends BaseRepository<ScheduleWorkCountYearDto, String>{
	...
	public List<ScheduleWorkCountYearDto> selectScheduleWorkCountYear(String year);
}
