 ...
 */
@Repository
public interface ScheduleWorkCountMonthRepository extends BaseRepository<ScheduleWorkCountMonthDto, String>{
	...
	public List<ScheduleWorkCountMonthDto> selectScheduleWorkCountMonth(String ym, String year);
}
